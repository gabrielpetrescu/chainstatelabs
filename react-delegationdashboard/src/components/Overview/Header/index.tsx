...
const Header = () => {
  ...
  return (
    <div className="header card-header d-flex align-items-center border-0 justify-content-between px-spacer dashboard-card">
      <div className="py-spacer text-truncate">
        <p className="text-left small-p p-dark-blue p-bold">Contract Address</p>
        <p className="text-left small-p ">{delegationContract}</p>
      </div>
